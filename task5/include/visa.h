...
/*                                                                           */
/* This file includes R&S extensions of the VISA, which should be enabled    */
/* by the compiler macro RSVISA_EXTENSION                                    */
/*---------------------------------------------------------------------------*/
...
/*- R&S specific extensions of the VISA -----------------------------------*/

#ifdef RSVISA_EXTENSION

# define VI_RS_ATTR_TCPIP_FIND_RSRC_TMO     0x0FAF0001UL           /* Timeout for VXI Discovery in Milliseconds */

# define VI_RS_ATTR_TCPIP_FIND_RSRC_MODE    0x0FAF0002UL
# define VI_RS_FIND_MODE_NONE                               0x00UL /* bypass the current (static) configured TCPIP resources */
# define VI_RS_FIND_MODE_CONFIG                             0x01UL /* looks for static configured LAN devices */
# define VI_RS_FIND_MODE_VXI11                              0x02UL /* looks on all NICs for VXI-11 devices */
# define VI_RS_FIND_MODE_MDNS                               0x04UL /* looks on all NICs for LXI devices > V1.3 */

// Attributes for a find list handle
# define VI_RS_ATTR_LXI_MANF                0x8FAF0003UL          /* LXI Manufacturer */
# define VI_RS_ATTR_LXI_MODEL               0x8FAF0004UL          /* LXI Model */
# define VI_RS_ATTR_LXI_SERIAL              0x8FAF0005UL          /* LXI Serial number */
# define VI_RS_ATTR_LXI_VERSION             0x8FAF0006UL          /* LXI Firmware version */
# define VI_RS_ATTR_LXI_DESCRIPTION         0x8FAF0007UL          /* LXI Description of a device */
# define VI_RS_ATTR_LXI_HOSTNAME            0x8FAF0008UL          /* LXI Hostname of a device */
